...
const re_vdb = loaded_vdb.asRetriever(
    //  {} optinal config
...
//             if (msg.toLowerCase() === "exit") // Fixed: Added parentheses after toLowerCase
//                 rl.close()
//             else {

//                 // Use similaritySearch to find the most similar documents
//                 const similarDocs = await loaded_vdb.similaritySearch(msg, 3);

//                 // Add the most similar documents to the chat history
//                 for (const doc of similarDocs) {
//                     chat.({
//                         role: "system",
//                         content: doc // Assuming doc is a string
//                     });
//                 }
